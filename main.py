...
def wishMe():
    ...
    elif(hour>=12)  and (hour<=19) and ('PM' in t):
        speak(f"Good afternoon Alisha, it's {day} and the time is {t}")
    else:
